      ...
      <div className="max-w-7xl mx-auto px-4 md:px-6">
        <div className="max-w-4xl mx-auto text-center text-white space-y-12">
          ...
          <div className="flex flex-col sm:flex-row gap-3 justify-center items-center pt-8">
            ...
            <Button variant="nextdoc-labs" size="lg" className="hover:scale-105 transition-transform duration-200" aria-label="Explore NextDoc Labs" onClick={() => navigate('/nextdoc-labs')}>
              NextDoc Labs
            </Button>
          </div>
        </div>
